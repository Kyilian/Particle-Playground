...
fn vs_main(
    ...
    let particle_size: f32 = 8.0;
    let screen_width: f32 = 800.0;
    let screen_height: f32 = 600.0; //man kann hier nicht auf die Rust-konstanten zurückgreifen
...
impl Vertex {
    ...
    const QUAD: [Vertex; 6] = [
        Vertex {position: [-0.5, -0.5] },   //u l
        Vertex {position: [0.5, -0.5] },    //u r
        Vertex {position: [0.5, 0.5] },     //o r

        Vertex {position: [-0.5, -0.5] },   //u l
        Vertex {position: [0.5, 0.5] },     //o r
        Vertex {position: [-0.5, 0.5] },    //o l
    ];
